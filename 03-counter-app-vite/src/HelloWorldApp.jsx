...
export const HelloWorldApp = () => {
  return (
    ...
    <aside className=" w-56 max-h-screen px-4 py-8 overflow-y-auto bg-white border-r rtl:border-r-0 rtl:border-l dark:bg-gray-900 dark:border-gray-700">
    <a href="#">
    ...
    <div>
        <p className='text-center m-auto '>Volver a <button className='hover:bg-purple-600 rounded-md'> <Link to='/'>Inicio</Link></button></p>
    </div>
